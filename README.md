...
- **[keke](https://github.com/milisp/keke-agent)** - Vendor-agnostic coding agent that runs in your terminal. Speaks ACP and routes existing ChatGPT or Grok logins across multiple accounts.
